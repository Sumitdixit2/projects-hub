            ...
            <Card className="bg-[#050505] border-border grid grid-cols-1 md:grid-cols-2 divide-y md:divide-y-0 md:divide-x divide-border/50">
              ...
              <div className="p-6 space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-[14px] font-semibold text-foreground">UNAVAILABLE</p>
                ...
                <div className="space-y-3 pt-2">
                  {[
                    { icon: Globe, label: "Website", value: "NOT_CONFIGURED" },
                    { icon: Mail,  label: "Contact", value: "UNAVAILABLE" },
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <span className="text-[12px] font-mono text-foreground">{user?.agency_id || "UNKNOWN"}</span>
                    </div>
                  </div>

                  <div className="flex items-center gap-2 pt-2">
                    <StatusBadge status="info" label="UNKNOWN PLAN" />
