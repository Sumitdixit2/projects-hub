...
export default function DeveloperSettingsPage() {
  ...
  return (
    <AppShell role="admin">
      <DashboardLayout
        title="Settings"
        subtitle="Manage your profile and execution environment."
      >
                ...
                {[
                  ...
                  },
                  {
                    ...
                    value: (
                      <StatusBadge
                        status="info"
                        label={user.role?.toUpperCase() || "DEVELOPER"}
                        className="text-[10px]"
                      />
                    ),
                    isComponent: true,
            ...
            <Card className="bg-[#050505] border-border grid grid-cols-1 md:grid-cols-2 divide-y md:divide-y-0 md:divide-x divide-border/50">
              ...
              <div className="p-6 space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-[14px] font-semibold text-foreground">Operator Access</p>
                    <p className="text-[11px] text-muted-foreground font-mono">Development & Execution</p>
                  </div>
                </div>

                <div className="space-y-3 pt-2">
                  <p className="text-[12px] text-muted-foreground leading-relaxed">
                    This workspace is restricted to operational execution. You can view assigned projects and update milestone telemetry.
                  </p>
                </div>
              </div>
              ...
              <div className="p-6 space-y-4 flex flex-col justify-center">
                <div className="space-y-3">
                  <div className="flex items-center gap-2">
                    <StatusBadge status="info" label="DEVELOPER TIER" />
