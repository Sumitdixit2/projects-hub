...
export default function ClientMilestoneDetailsPage() {
      ...
      <DashboardLayout
        ...
        subtitle={
          <span className="flex items-center gap-1.5 text-muted-foreground text-[12px] font-mono">
            ...
            <button
              onClick={() => router.push(`/client/project/${milestone.project_id}`)}
        ...
        actions={
          <div className="flex items-center gap-3">
            <div
              className={cn(
                "flex items-center gap-1.5 h-8 px-3 rounded-md border text-[12px] font-medium",
                "bg-[#0a0a0a] border-border text-foreground"
              )}
            >
