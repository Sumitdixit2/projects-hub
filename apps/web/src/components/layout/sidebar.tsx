...
export default function Sidebar({ role }: SidebarProps) {
  ...
  const links = {
    ...
    client: [
      ...
      { href: "/client/settings", label: "Settings", icon: <GearIcon /> },
    ],
  };
        ...
        <div className="flex flex-col gap-4">
          <div className="flex flex-col">
            <h1 className="text-[#0e141b] text-base font-medium leading-normal">
              {role === "admin" ? "Agency Co." : role === "agency" ? "My Agency" : "Client Portal"}
            </h1>
            <p className="text-[#4e7397] text-sm font-normal leading-normal capitalize">{role}</p>
          </div>
              ...
              return (
                <Link
                  ...
                  className={cn(
                    ...
                    isActive ? "bg-[#e7edf3]" : "hover:bg-[#e7edf3]"
                  )}
                >
                  <div
...
function UsersIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
      <path d="M244.8,150.4a8,8,0,0,1-11.2-1.6A51.6,51.6,0,0,0,192,128a8,8,0,0,1-7.37-4.89,8,8,0,0,1,0-6.22A8,8,0,0,1,192,112a24,24,0,1,0-23.24-30,8,8,0,1,1-15.5-4A40,40,0,1,1,219,117.51a67.94,67.94,0,0,1,27.43,21.68A8,8,0,0,1,244.8,150.4ZM190.92,212a8,8,0,1,1-13.84,8,57,57,0,0,0-86.16,0,8,8,0,1,1-13.84-8,72.63,72.63,0,0,1,35.82-35.39,48,48,0,1,1,44.1,0A72.63,72.63,0,0,1,190.92,212ZM80,136a8,8,0,0,0-8,8,52,52,0,0,1-52,52,8,8,0,0,0-8,8,8,8,0,0,0,8,8,68,68,0,0,0,68-68A8,8,0,0,0,80,136Zm0-16a40,40,0,1,0-40-40A40,40,0,0,0,80,120Z"></path>
    </svg>
  );
}
